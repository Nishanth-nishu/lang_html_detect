...
samples = [
    # Sample 1
    "本研究的关键结果表明该模型在不同条件下具有稳定性，并且方法可以推广到更复杂的数据场景。作者还补充说明：这个结论需要在更大样本上进一步验证。 في هذا الجزء، يوضح الباحث أن النتائج الأولية مشجعة، لكن هناك حاجة إلى تجارب إضافية قبل اعتماد الاستنتاج النهائي. இந்த பகுதியில், ஆய்வின் முக்கிய கருத்துக்களாக தெரிகின்ற விளக்கப்படுகிறது, மேலும் அதன் அடிப்படையில் முடிவுகள் அதிகரிக்கப்படுகின்றன.",
    ...
    # Sample 7
    "Nel libro, l’introduzione presenta lo sfondo e un breve riassunto con parole chiave; nel primo capitolo compaiono anche titolo, sottotitolo, nota e conclusione. La sezione finale include conclusioni, bibliografia, glossario e Ulteriore lettura, mentre in appendice troviamo allegato, appendice e appendici con materiale extra. Per la parte tecnica, il testo usa definition, definizioni, ipotesi, metodo e metodi, con passaggi matematici como Eq., Eqn., equazione, formula, espressione, lemma, teorema, corollario, proposta e prova. I risultati sono mostrati con fig., figura, tabella, grafico, diagramma, schema e casella di testo, con fonte verificata per ogni elemento. Nel blocco metadata compaiono abbreviation, abbreviazioni, nomenclatura, classificazione, codici, indice dei termini, Indice chimico, indice materiale, fonte indice e Termine thesaurus. Il contenuto copre geochimica, nuova astronomia e biologia molecolare e cellulare, con riferimenti a materiale, materiali, relazione, reazione, regressione e risultati.",
    ...
    # Sample 11
    "In this single mixed-English test paragraph, we greet the world with one word from many major languages: hello, hola, bonjour, olá, ciao, hallo, привет, 你好, こんにちは, 안녕하세요, नमस्ते, নমস্কার, ਸਤ ਸ੍ਰੀ ਅਕਾਲ, నమస్తే, नमस्कार, வணக்கம், سلام, مرحبا, merhaba, xinchào, สวัสดี, မင်္ဂလာပါ, សួស្តី, ສະບາຍດີ, ආයුබோවன், નમસ્તે, ನಮસ્කාර, நமஸ்காரம், ନമස්કાર, নমস্காৰ, γεια, שלום, jambo, sannu, bawo, ndewo, salaan, sawubona, molo, hej, hei, moi, dia, helo, kaixo, salut, cześć, ahoj, szia, bok, zdravo, živjo, labas, sveiki, tere, përshேndetje, здраво, გამარჯობა, բარև, salam, сәлем, salom, салам, салом, сайн, silav, kiaora, talofa, malo, bula, salama, bonjou, saluton, salve, and this sentence keeps all these words together so you can test word-level and sentence-level multilingual detection inside one paragraph. \nLa tecnología ha cambiado la manera en que las personas viven, trabajan y se comunican. Hoy en día, many tasks that once took hours can be completed in a few minutes thanks to digital tools. Además, el acceso a la información es más rápido que nunca, lo que permite a los estudiantes and profesionales aprender nuevas habilidades con mayor facilidad. Sin embargo, también es importante usar la tecnología de forma responsable and mantener un equilibrio con la vida personal.\nViajar a un país diferente puede ser una experiencia muy enriquecedora. No solo permite conocer nuevos lugares, sino también descubrir culturas, comidas y tradiciones distintas. Muchas personas consideran que viajar les ayuda a ampliar su perspectiva del mundo and a desarrollar mayor empatía hacia los demás. Aunque a veces puede haber dificultades, como el idioma o la adaptación, los recuerdos and aprendizajes que se obtienen suelen valer mucho la pena."
]

for i, text in enumerate(samples, 1):
    output = annotate(text)
    print(f"\n--- Sample {i} ---")
    print(output)
